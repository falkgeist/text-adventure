...
public class Game {
    public static void main(String[] args) {
        ...
        Item bed1 = new Item("bed", "bed", "The bed is in bad shape and the sheets are old and torn.", "There is an iron bed with old sheets and in bad shape standing on one side of the room.");
        ...
        Item door1 = new Item("door", "door", "The door is wooden and seems to be sturdy.", "On the other side is a door.", exitLoc1toLoc2, key1);
